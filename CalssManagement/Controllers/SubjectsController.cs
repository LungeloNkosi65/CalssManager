...
namespace CalssManagement.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectId,SubjectName,Mark")] Subjects subjects)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectId,SubjectName,Mark")] Subjects subjects)
        {
            if (ModelState.IsValid)
            {
